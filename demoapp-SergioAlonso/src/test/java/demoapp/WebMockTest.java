...
public class WebMockTest {
    ...
    @Test
    public void greetingShouldReturnMessageWithUserInfo() throws Exception {

        when(service.saluda("Domingo")).thenReturn("Hola Mock Domingo");
        when(service.ageAndIdMessage(19, "35581834Y")).thenReturn("Tu edad es: 19 y tu DNI es 35581834Y");
